...
import introImg from '../assets/about-more-gym.jpeg';
import approachImg from '../assets/about-train.jpeg';
import communityImg from '../assets/about-how-we-help.jpeg';
import recoveryImg from '../assets/about-recovery.jpeg';
// Removed footerImg import
  ...
  return (
    <div ref={containerRef} className="bg-wild-black text-wild-white pt-20 overflow-x-hidden relative" dir={isArabic ? 'rtl' : 'ltr'}>
      ...
      <section className="relative min-h-[80vh] flex flex-col justify-center px-6 z-10 pt-20 border-b border-wild-dark/30">
        ...
        {/* HERO BACKGROUND */}
        <motion.div style={{ y: yFast }} className="absolute top-0 right-0 w-full md:w-3/4 h-full opacity-40 z-[-1]">
          <img src={heroImg} className="w-full h-full object-cover" alt="Wilds Gym Atmosphere" />
      ...
      {/* --- SECTION 1: MORE THAN JUST A GYM --- */}
        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
             <div className="aspect-[3/4] relative overflow-hidden border-2 border-wild-dark shadow-2xl shadow-wild-black">
                {/* Full Color Image */}
                <img src={introImg} className="w-full h-full object-cover" alt="Gym Interior" />
             </div>
          </motion.div>
        ...
        <div className="container mx-auto flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-32 relative z-10">
          ...
          >
             <div className="aspect-[16/9] relative overflow-hidden border-2 border-wild-dark shadow-2xl shadow-wild-black lg:translate-x-12">
                {/* Full Color Image */}
                <img src={approachImg} className="w-full h-full object-cover" alt="Training Area" />
             </div>
          </motion.div>
        ...
        <div className="container mx-auto grid lg:grid-cols-2 gap-20 items-start relative">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} className="relative z-20">
                <div className="aspect-square relative border-4 border-wild-black shadow-[0_0_50px_rgba(0,0,0,0.5)] z-20 overflow-hidden">
                    {/* Full Color Image */}
                    <img src={recoveryImg} className="w-full h-full object-cover" alt="Recovery Zone" />
      ...
      <section className="py-24 px-6 relative z-10">
         <div className="absolute inset-0 bg-wild-accent/5 skew-y-[-2deg] z-0">
            <div className="absolute inset-0 opacity-10 bg-cover bg-center mix-blend-overlay" style={{ backgroundImage: `url(${communityImg})` }}></div>
         </div>
        ...
        <div className="container mx-auto px-6 relative z-20 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
            <h2 className={`text-5xl md:text-8xl uppercase text-wild-white mb-8 tracking-tighter ${fontDisplay}`}>
              {isArabic ? 'زور' : 'Visit'} <span className="text-wild-accent px-2 relative">{isArabic ? 'وايلدز جيم' : 'Wilds Gym'}</span> {isArabic ? 'بالصويفية' : 'in Sweifieh'}
            </h2>
